...
import com.training.spring.model.TransactionType;
import com.training.spring.repository.*;


@Service
public class BankServiceImpl implements BankService {
	
	@Autowired @Qualifier("accountRepository") 
	...
	/*
	 * Put all the initialization logic into this method as constructor won't work
	 */
	@PostConstruct
	...
	/*
	 * Put all the destruction logic into this method
	 */
	@PreDestroy
